...
while true; do
    ...
    [yY])
        ...
        $HOME/Android/cmdline-tools/bin/sdkmanager --sdk_root=$HOME/Android/Sdk build-tools\;35.0.0 ndk\;28.2.13676358 cmake\;4.0.2 platform-tools platforms\;android-36 cmdline-tools\;latest emulator
        cd $HOME
...
source "\$HOME/.cargo/env"
export PATH=\$PATH:\$HOME/Android/Sdk/ndk/28.2.13676358/toolchains/llvm/prebuilt/linux-x86_64/bin:\$HOME/Android/Sdk/platform-tools:\$HOME/Android/Sdk/cmdline-tools/latest/bin
